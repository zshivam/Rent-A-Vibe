  ...
  return (
    <main className="container-page py-16 sm:py-20 space-y-16">
      <div className="text-center space-y-3 max-w-2xl mx-auto">
        ...
        <h1 className="section-heading text-4xl sm:text-6xl font-extrabold text-slate-900 font-heading">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
        {steps.map(({ icon: Icon, step, title, desc }) => (
          <div key={step} className="glass-card p-8 group hover:border-purple-400 transition-all border border-slate-200 bg-white shadow-sm">
            <div className="flex items-start gap-4">
              <div className="p-3.5 rounded-2xl bg-purple-100 border border-purple-200 text-purple-700 shrink-0 shadow-sm">
                <Icon className="w-6 h-6" />
              </div>
              <div className="space-y-1.5">
                <span className="text-xs font-mono text-purple-700 font-extrabold block">{step}</span>
      ...
      <div className="text-center pt-6">
        <Link href="/venues/the-dwarka-party-flat" className="btn-primary text-base px-10 py-4 shadow-lg inline-flex items-center gap-2 font-extrabold">
