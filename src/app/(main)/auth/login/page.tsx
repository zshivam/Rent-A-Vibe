...
import { Mail, Lock, Loader2, Sparkles, Zap, ArrowRight, AlertCircle } from 'lucide-react';
...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      // Fallback to Instant Google Demo session
      saveDemoUser({
        id: 'usr-google-888',
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    // 2. Dummy fallback: Log in instantly with whatever email was entered
    saveDemoUser({
