...
export default function DashboardPage() {
  ...
  if (!user) {
    return (
      <main className="container-page py-16 max-w-lg mx-auto text-center">
        <div className="glass-card p-10 space-y-6 border border-white/10 bg-slate-900/90 shadow-2xl">
  ...
  return (
    <main className="container-page py-12 space-y-8">
      {/* Header */}
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 glass-card p-6 border border-white/10 bg-slate-900/80 shadow-xl">
        <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="glass-card p-5 border border-white/10 bg-slate-900/80 shadow-md">
          <div className="flex items-center gap-3 text-slate-300 text-sm mb-2 font-semibold">
            <Package className="w-4 h-4 text-purple-400" /> Active Rentals
          </div>
          <p className="text-2xl font-black text-white font-heading">0</p>
          <p className="text-xs text-slate-400 mt-1 font-medium">Delivered to your location</p>
        </div>

        <div className="glass-card p-5 border border-white/10 bg-slate-900/80 shadow-md">
          <div className="flex items-center gap-3 text-slate-300 text-sm mb-2 font-semibold">
            <Shield className="w-4 h-4 text-emerald-400" /> Refundable Deposits
          </div>
          <p className="text-2xl font-black text-emerald-400 font-heading">₹0</p>
          <p className="text-xs text-slate-400 mt-1 font-medium">Returned post-inspection</p>
        </div>

        <div className="glass-card p-5 border border-white/10 bg-slate-900/80 shadow-md">
          <div className="flex items-center gap-3 text-slate-300 text-sm mb-2 font-semibold">
            <Clock className="w-4 h-4 text-amber-400" /> Total Experiences
          </div>
          <p className="text-2xl font-black text-white font-heading">0</p>
          <p className="text-xs text-slate-400 mt-1 font-medium">Lifetime bookings</p>
        </div>
      </div>

      {/* Booking List */}
      <div>
        <h2 className="text-xl font-bold text-white mb-4 font-heading">Your Bookings</h2>
        <div className="glass-card p-12 text-center border border-white/10 bg-slate-900/70 shadow-xl">
          <Package className="w-16 h-16 text-slate-600 mx-auto mb-4" />
          <p className="text-white text-lg font-bold font-heading">No bookings yet</p>
